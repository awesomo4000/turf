// Windows/WebView2 specific turf.js implementation
...
@keyframes rainbowShimmer {
  ...
  100% {
    ...
    // Listen for messages from the native application (WebView2 approach)
    if (window.chrome && window.chrome.webview) {
        window.chrome.webview.addEventListener('message', function(event) {
            // Message received from native
            
            // PostWebMessageAsJson sends the data as a parsed object, not a string
